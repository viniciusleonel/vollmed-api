...
4. Escolha seu banco de dados favorito selecionando uma branch.
5. Configure as var de ambiente em .env =  
   DB_HOST=db
   DB_PORT=3306 ou 5432
   DB_NAME=voll_med_api
   DB_USERNAME=root
   DB_PASSWORD=root123
6. Execute a aplicação. A API estará disponível em `http://localhost:8080`.
